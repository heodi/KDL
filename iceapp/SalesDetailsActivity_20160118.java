...
public class SalesDetailsActivity_20160118 extends Activity {
    ...
    private ListView.OnItemClickListener detailsClick = new ListView.OnItemClickListener() {
        ...
        public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        	...
        	if (tc.equals("PG")) {
        		...
        		qtyTxt.setText("");
        		btnShow();
        		util.showDialog("不過更改 PG 類別的資料", SalesDetailsActivity_20160118.this);
        	}
        	else {
    ...
    private Button.OnClickListener copyClick = new Button.OnClickListener() {
    	...
    	public void onClick(View v) {
    		if (copyBtn.getText().toString().equals("消單")) {
        		AlertDialog.Builder ab = new Builder(SalesDetailsActivity_20160118.this);
        		...
        		Intent it = new Intent(SalesDetailsActivity_20160118.this, CopyInvoicesActivity.class);
    ...
    private Button.OnClickListener saveClick = new Button.OnClickListener() {
    	...
    	public void onClick(View v) {
    		if (saveBtn.getText().toString().equals("儲存")) {
            	...
            	Intent it = new Intent(SalesDetailsActivity_20160118.this, SalesInvTotalActivity.class);
            	Bundle bundle = new Bundle();
    ...
    private Button.OnClickListener modifyClick = new Button.OnClickListener() {
    	...
    	public void onClick(View v) {
    		...
    		*/
    		if (qty > onHand) {
    			util.showDialog("所輸入之數量大於存貨數量", SalesDetailsActivity_20160118.this);
    			qtyTxt.requestFocus();
    		} else if (qty <= 0) { 
    			util.showDialog("所輸入之數量必需大於0", SalesDetailsActivity_20160118.this);
    			qtyTxt.requestFocus();
    		} else {
    			if (!tc.equals(ordAList.get(pos).get("tranCode").toString())) {
    				ordAList.get(pos).put("tranCode", tc);
				...
				if (tc.equals("NS")) {    					
					ordAList.get(pos).put("uPrice", util.getUprice(SalesDetailsActivity_20160118.this
							, dbh
							, db
							, priceBk
							, ordAList.get(pos).get("itemCode")
				...
				mListView.invalidateViews();
				saveBtn.setText("儲存");
				Toast toast = Toast.makeText(SalesDetailsActivity_20160118.this, "已修改", Toast.LENGTH_SHORT);				
				toast.show();    					
    		}    		
    	}
    };
    ...
    private Button.OnClickListener itemAddClick = new Button.OnClickListener() {
    	@Override
    	public void onClick(View v) {
        	Intent it = new Intent(SalesDetailsActivity_20160118.this, AddSalesDetailsActivity.class);            		
        	Bundle bundle = new Bundle();
        	bundle.putString("ActName", "SalesDetailsActivity");
    ...
    private void cancelOrder() {
    	try {
    		...
    		util.showDialog("Update Error!!!", SalesDetailsActivity_20160118.this);
    	} finally {
    		db.endTransaction();
    		db.close();
    	}
    ...
    private void saveOrders() {
    	try {
    		...
    		modified = false;
    		refreshOrdAList();
			Toast toast = Toast.makeText(SalesDetailsActivity_20160118.this, "已儲存", Toast.LENGTH_SHORT);				
			toast.show();    					
    	} catch (SQLException e) {
    		util.showDialog("Update Error!!!", SalesDetailsActivity_20160118.this);
    	} catch (Exception e) {
    		util.showDialog(e.getMessage(), SalesDetailsActivity_20160118.this);
    	} finally {
    		db.endTransaction();
    		db.close();
    	}
    ...
    private double insSalesDtl() throws Exception {
		...
		while (it.hasNext()) {
			...
			uamt = Double.parseDouble(hm.get("uPrice"));
			if (!statusTxt.getText().equals("")) {
				if (hm.get("tranCode").equals("NS")) {
					...
					namt = Double.parseDouble(util.getUprice(SalesDetailsActivity_20160118.this
							, dbh
							, db
							, priceBk
							, itemCode
    ...
    private void insPromotion(int iLine) throws Exception {
    	...
    	if (c.moveToFirst()) {
    		do {
    			promoList = util.getPromoItemQty(SalesDetailsActivity_20160118.this
    					, dbh
    					, db
    					, custCode
    					, custGroup
        ...
        if (d.moveToFirst()) {
        	...
        	do {
        		...
        		if (tranCode.equals("NS")) {
    				ordHmap.put("uPrice", util.getUprice(SalesDetailsActivity_20160118.this
    						, dbh
    						, db
    						, priceBk
    						, itemCode
    	...
    	if (modified) {
    		...
    		ab.setPositiveButton("確認", new DialogInterface.OnClickListener() {
    			...
    			public void onClick(DialogInterface dialog, int which) {
    				// TODO Auto-generated method stub
    				dialog.dismiss();
    				SalesDetailsActivity_20160118.this.finish();
    			}
    		});
    		ab.setNegativeButton("取消", new DialogInterface.OnClickListener() {
    			@Override
